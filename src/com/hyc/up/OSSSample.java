...
public class OSSSample {
	...
	public OSSSample(Context context, String uploadFilePath, OSS oss, ImgInfo imgInfo, String object,SQLiteDatabase dbWriter,Handler scInfoHandler) {
		this.context = context;
		this.uploadFilePath = uploadFilePath;
		this.oss = oss;
		this.imgInfo = imgInfo;
...
//							dir.mkdirs();
//						}
//						copyFile(uploadFilePath, Environment.getExternalStorageDirectory()+"/baige/twoFile/"+uploadFilePath.substring(uploadFilePath.lastIndexOf("/")+1,uploadFilePath.length()));
//						DeleteFilePic.delete(new File(uploadFilePath));
